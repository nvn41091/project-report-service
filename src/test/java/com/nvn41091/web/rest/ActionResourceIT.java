...
public class ActionResourceIT {
    ...
    public void createAction() throws Exception {
        ...
        assertThat(testAction.getUpdateTime()).isEqualTo(DEFAULT_UPDATE_TIME);
        assertThat(testAction.isStatus()).isEqualTo(DEFAULT_STATUS);
    }
    ...
    public void updateAction() throws Exception {
        ...
        assertThat(testAction.getUpdateTime()).isEqualTo(UPDATED_UPDATE_TIME);
        assertThat(testAction.isStatus()).isEqualTo(UPDATED_STATUS);
    }
